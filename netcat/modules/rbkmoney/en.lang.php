...
define('SAVE_LOGS', 'Write logs RBKmoney');
...
define('DELETE_LOGS', 'Delete logs');
define('DOWNLOAD_LOGS', 'Download logs');
define('LOGS_DELETED', 'Logs deleted');
define('LOGS_DELETE_ERROR', 'Logs delete error');